  ...
  <header id="site-header" class="fixed-top">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark stroke">
        ...
        <a class="navbar-brand" href="index">
          <img src="assets/image/logo.png" alt="Logo" title="Logo" style="height:100px;" />
        </a>
    ...
    <div class="contact-grids d-grid mt-5 mx-lg-5">
      ...
      <div class="contact-right">
        ...
        <?php
            ...
            echo '<p div class="alert alert-success">Thank you for filling this form. One of our agents would contact you.</p>'
    ...
    <div class="footer-29 py-5">
        <div class="container py-lg-3">
            <div class="row footer-top-29">
                ...
                <div class="col-lg-5 col-sm-6 footer-list-29 footer-2 mt-lg-0 mt-md-5 mt-4">
                    ...
                    <div class="cont-details">
                        ...
                        <div class="cont-top margin-up">
                          ...
                          <div class="cont-right">
                            <p><a href="mailto:info@globalwissen.com" class="mail">
                                info@globalwissen.com</a></p>
                          </div>
                        </div>
                        <div class="cont-top margin-up">
                            <div class="cont-left text-center">
                ...
                <div class="col-lg-3 col-sm-6 footer-list-29 footer-2 mt-lg-0 mt-md-5 mt-4">
                    ...
                    <ul>
                        ...
                        <li><a href="#doc"> Legal Policy</a></li>
...
<section class="w3l-copyright">
    <div class="container">
        <div class="row bottom-copies">
            <p class="col-lg-8 copy-footer-29">© 2024 Global Wissen. All rights reserved.</p>
